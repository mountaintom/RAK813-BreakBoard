# 1 "/Applications/SEGGER Embedded Studio for ARM 4.16/samples/SEGGER_THUMB_Startup.s"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Applications/SEGGER Embedded Studio for ARM 4.16/samples/SEGGER_THUMB_Startup.s"
# 58 "/Applications/SEGGER Embedded Studio for ARM 4.16/samples/SEGGER_THUMB_Startup.s"
  .syntax unified
...
# 85 "/Applications/SEGGER Embedded Studio for ARM 4.16/samples/SEGGER_THUMB_Startup.s"
3:
  subs r2, r2, #0x80
  beq 10f
  ldrb r3, [r1]
...
4:
  ...
  bne 4b
  b 2b
# 116 "/Applications/SEGGER Embedded Studio for ARM 4.16/samples/SEGGER_THUMB_Startup.s"
1:
  ldrb r3, [r1]
  adds r1, r1, #1
  strb r3, [r0]
...
4:
  bx lr
# 248 "/Applications/SEGGER Embedded Studio for ARM 4.16/samples/SEGGER_THUMB_Startup.s"
  .global _start
  .extern main
  .global exit
  .weak exit
...
ctor_end:
  ...
  .type start, function
start:
# 321 "/Applications/SEGGER Embedded Studio for ARM 4.16/samples/SEGGER_THUMB_Startup.s"
  movs r0, #0
  movs r1, #0
  ...
  .thumb_func
exit:
# 357 "/Applications/SEGGER Embedded Studio for ARM 4.16/samples/SEGGER_THUMB_Startup.s"
exit_loop:
  b exit_loop
